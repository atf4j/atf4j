 ...
 */
package net.atf4j.core.webdriver.example.frontend.po;
...
public class FrontendPage extends WebPage {
	...
	// protected final WebDriverConfig sportBookConfig = new SportBookConfig();
	...
	public FrontendPage open() {
		...
		getWebDriver().get("http://sports.atf4j.net");
		return this;
	}
