...
/**
 * The AbstractComposite.
 */
public class AbstractComposite implements Composite {

    protected final Map<String, Composite> map = new HashMap<String, Composite>();

    protected final List<Composite> children = new ArrayList<Composite>();
