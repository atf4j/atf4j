...
public abstract class AbstractTestBase extends TestResultsReporting {
     ...
     * @return the test base
     */
    public AbstractTestBase setTestStatus(final TestResult testStatus) {
     ...
     * @return the test base
     */
    public AbstractTestBase setUniqueIdentifier(final TestIdentifier uniqueIdentifier) {
     ...
     */
    public TestIdentifier getUniqueIdentifier() {
     ...
     * @return the test base
     */
    public AbstractTestBase setTester(final String tester) {
        this.tester = tester;
        return this;
    }
     ...
     * @return the test base
     */
    public AbstractTestBase setName(final String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the test base
     */
    public AbstractTestBase setTaxonomy(final String taxonomy) {
     ...
     * @return the test base
     */
    public AbstractTestBase setDescription(final String description) {
     ...
     * @return the test base
     */
    public AbstractTestBase setTimestamp(final String timestamp) {
